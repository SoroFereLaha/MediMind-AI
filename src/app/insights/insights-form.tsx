...
const specialties = [
  ...
  { value: 'Neurology', label: 'Neurology', icon: BrainIcon },
  { value: 'Pulmonology', label: 'Pulmonology', icon: LungIcon },
...
function StomachIcon(props: React.SVGProps<SVGSVGElement>) { return <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 15c-2.761 0-5-2.239-5-5s2.239-5 5-5 5 2.239 5 5-2.239 5-5 5z"/><path d="M12 10v4m-2-2h4"/></svg>;} // Generic plus for medical
    ...
    <Card className="shadow-lg">
      ...
      {result && (
        <div className="p-6 border-t">
          <h3 className="font-headline text-2xl font-semibold mb-4 text-primary">{specialty} Insights</h3>
