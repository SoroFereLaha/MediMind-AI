...
export default function HomePage({ params: routeParams }: { params: { locale: string } }) {
  ...
  // Content below is for the "Patient" role or if no role is selected yet (though AppLayout handles role selection)
  ...
  // Render patient homepage content if role is patient or null (RoleSelector will show if null)
  if (userRole === 'medecin') {
